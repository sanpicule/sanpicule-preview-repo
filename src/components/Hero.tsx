...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="relative bg-cream min-h-screen flex items-end px-6 md:px-12 pb-[42vh] md:pb-[38vh] overflow-hidden"
    >
      <svg
      ...
      <div className="absolute right-6 md:right-10 bottom-[28vh] flex flex-col items-center gap-3 pointer-events-none">
        <span
